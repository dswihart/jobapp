...
type TabType = 'cv' | 'basic' | 'experience' | 'preferences' | 'resumes'
...
const loadProfile = useCallback(async () => {
  ...
  const tabs = [
    ...
    { id: 'resumes' as TabType, name: 'Resumes', icon: DocumentTextIcon },
  ]
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden">
      ...
      <div className="fixed inset-0 sm:inset-4 sm:m-auto sm:max-w-4xl sm:w-full sm:h-fit sm:max-h-[90vh] bg-white dark:bg-gray-800 sm:rounded-lg shadow-xl flex flex-col">

        {/* Header - sticky */}
        <div className="flex-shrink-0 sticky top-0 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-4 sm:px-6 py-4 flex items-center justify-between z-20">
        ...
        <div className="flex-shrink-0 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 z-10">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                    Your preferred work location or Remote for remote-only positions
                  </p>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                    Add multiple preferred locations for job searching
                  </p>
                </div>
        ...
        {/* Footer */}
        <div className="flex-shrink-0 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 px-4 sm:px-6 py-4 flex flex-col-reverse sm:flex-row justify-end gap-3">
          <button
            onClick={onClose}
