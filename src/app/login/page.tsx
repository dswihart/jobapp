...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-neutral-50 dark:bg-neutral-950">
      ...
      {/* Goal Achievement Section - Left-to-Right Chronological */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
            <div className="text-center mb-4">
              <h2 className="text-lg sm:text-xl font-bold text-neutral-900 dark:text-neutral-50">
                Daily Goal Achievement - {dailyGoal} Applications/Day
              </h2>
            </div>
              ...
              <div className="flex gap-2 sm:gap-3 justify-start sm:justify-center px-2 sm:px-0">
                {displayStats.dailyStats.map((day, index) => {
                  ...
                  return (
                    <div
                      key={day.date}
                      className={`flex-shrink-0 rounded-lg p-3 sm:p-4 text-center border-2 ${
                        goalMet
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mt-6">
                ...
                <div className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 rounded-lg p-3 sm:p-4 text-center border border-purple-200 dark:border-purple-800">
                  <div className="text-2xl sm:text-3xl font-bold text-purple-600 dark:text-purple-400">
                    {Math.round((displayStats.dailyStats.reduce((sum, day) => sum + day.count, 0) / 7) * 10) / 10}
                  </div>
